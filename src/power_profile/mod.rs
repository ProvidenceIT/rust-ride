...
pub use comparison::{
    female_reference_wpk, male_reference_wpk, DurationComparison, ProfileComparer,
    ProfileComparison, ReferenceCurve, ReferenceLevel,
};
pub use lifetime::{
    build_lifetime_from_history, LifetimeBest, LifetimeBestTracker, LifetimeCheckResult,
};
...
pub use types::{
    duration_label, get_duration_bucket, is_standard_duration, ProfileType, PROFILE_DURATIONS,
};
