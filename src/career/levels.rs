...
fn reward(
    ...
    name: &str,
    description: &str,
    color: impl Into<Option<&'static str>>,
) -> Reward {
...
mod tests {
    ...
    fn test_all_levels_defined() {
        ...
        for i in 1..=50 {
            assert!(levels.iter().any(|l| l.level == i), "Missing level {}", i);
        }
    }
